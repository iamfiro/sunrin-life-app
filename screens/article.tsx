...
export default function ScreenArticle({ route, navigation }: any) {
    ...
    return (
        ...
        <ScrollView style={style.container} onLayout={onLayoutRootView}>
            ...
            <View style={{ paddingHorizontal: 17.5, marginTop: 20 }}>
                <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                    ...
                    <Title size={5} color="#000000" weight="200">📄  숙제</Title>
                </View>
                <View style={{ height: 20 }} />
                <Title size={2} color="#000" weight="300">영어 3245p 숙제</Title>
                <View style={{ height: 20 }} />
                <Title size={4} color="#585858" weight="100">국어 전공관련책 2권읽기(8.15){'\n\n'}영어 멘토멘티 최대한 해오기{'\n\n'}컴시일 캔바를이용하여 교과서 한단원 정리후 제출하기(3.18)디일 스프링무선노트 가져오기(3.18){'\n\n'}반장 찬양하고 잠들기{'\n\n'}가정통신문{'\n'}-행정정보 공동이용서{'\n'}-방과후 신청서{'\n\n'}급식{'\n'}-후리카케작은밥(?)어묵국{'\n'}국물떡볶이{'\n'}찐순대{'\n'}분식튀김(만두,어묵,김말이){'\n'}단무지{'\n'}복숭아에이드(오우예ㅔㅔ){'\n'}대체찬(백미밥)</Title>
                <View style={{ height: 20 }} />
                <View style={{ flexDirection: 'row' }}>
                    <Title size={6} color="#838383" weight="200">2024-03-15  ·  23명 조회함  ·  </Title>
                    <Title size={6} color="#0080ff" weight="200">#📄 숙제</Title>
                </View>
