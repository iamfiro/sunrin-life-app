...
export default function ScreenCommunity({ navigation }: IDefaultScreenProps) {
    return (
        ...
        <View style={style.container}>
            ...
            <Title size={5} color="#000" weight="200" textAlign="center" marginBottom={10} marginTop={10}>커뮤니티를 활성화 하기에는{'\n'}아직 개구리가 울지 않았어요 (...)</Title>
            <Title size={5} color="#a1a1a1" weight="200" marginTop={10}>다른 학급 친구들에게 선린라이프를 많이 알려주세요!</Title>
        </View>
...
/* Styles for the community screen. */
